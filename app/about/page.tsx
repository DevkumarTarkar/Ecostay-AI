...
const AboutPage = () => {
  return (
    <main className="min-h-screen pt-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          >
            <div>
              ...
              <p className="text-primary/90 leading-relaxed text-lg font-medium">
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-3xl font-serif font-bold text-primary">Sustainable Vision</h2>
              </div>
              <p className="text-primary/90 leading-relaxed text-lg font-medium">
      ...
      <section className="py-24 bg-background border-y border-secondary/10">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-4xl font-serif font-bold text-primary text-center mb-16 italic">Why Travelers Choose Us</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              <div key={idx} className="text-center space-y-4">
                <div className="w-20 h-20 bg-primary/5 rounded-[2rem] flex items-center justify-center mx-auto mb-6 group hover:bg-secondary transition-colors duration-500">
                  <feature.icon className="w-10 h-10 text-primary transition-colors group-hover:text-white" />
                </div>
                <h3 className="text-2xl font-serif font-bold text-primary">{feature.title}</h3>
